...
siteURLGoogle = "ec2-52-205-164-138.compute-1.amazonaws.com"
...
def logingoogle():
    google = requests_oauthlib.OAuth2Session(
        googleClientID, redirect_uri=siteURLGoogle + "/callback-google", scope=googleScope
    )
...
def callbackgoogle():
	google = requests_oauthlib.OAuth2Session(
		googleClientID, redirect_uri=siteURLGoogle + "/callback-google", state=flask.session['oauth_state']
	)
